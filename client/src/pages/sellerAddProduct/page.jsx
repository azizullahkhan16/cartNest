        ...
        <div className="py-2 px-4 border rounded-lg shadow-md">
          ...
          <form className="mt-6" onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="mt-4  w-full max-w-lg">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="flex items-center hover:text-green-500 p-1 rounded-md"
                >
              ...
              <div className=" flex flex-wrap gap-2 border rounded-md px-2 py-1">
                {categories.length ? (
                  categories.map((el, idx) => (
                    <div
                      className="py-1 px-2 border border-zinc-400 rounded-full flex items-center"
                      key={idx}
                    >
            ...
            <div className="mt-5 w-full max-w-lg">
              ...
              {/* adding block */}
              <div
                className={`w-full my-2 border rounded-md p-2 ${
                  opencust ? "block" : "hidden"
                }`}
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    type="button"
                    className="text-xl text-green-600 px-2 "
                    onClick={(e) => {
                      setCustOptions((p) => {
                        const temp = [...p];
                        temp.push("");
                    ...
                    return (
                      <div className="flex items-center" key={idx}>
                        <input
                          type="text"
                          value={el}
                          className="px-2 py-1 mt-2 w-full max-w-[150px] border border-zinc-400 rounded-lg outline-none mb-3"
                          onChange={(e) => {
                            setCustOptions((p) => {
                              let temp = [...p];
                              temp[idx] = e.target.value;
                ...
                <div className="w-full">
                  <button
                    type="button"
                    className="px-3 py-1 mt-3 border border-primary hover:text-primary w-fit mx-auto rounded-lg font-nunito"
            ...
            <div className="mt-5 w-full max-w-lg">
              ...
              <div className="flex flex-wrap gap-4">
                {images.map((el, idx) => {
                  return (
                    <div
                      className="w-24 h-24  relative border rounded-md"
                      key={idx}
                    >
                      <button
                        type="button"
